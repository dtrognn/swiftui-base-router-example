...
public enum PopDestination {
    ...
    /// Pop back to the root view (i.e. the first view added to the DGNavigationStackView during the initialization process).
    case root
...
/// A view used to navigate back to a previous view through its enclosing DGNavigationPath.
public struct PopView<Label, Tag>: View where Label: View, Tag: Hashable {
    @EnvironmentObject private var navigationStack: NavigationPath
